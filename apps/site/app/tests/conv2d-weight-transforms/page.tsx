...
export default function Conv2DWeightTransformsTestPage() {
  return (
    <div style={styles.container}>
      <h1 style={styles.title}>Conv2D Weight Transforms Tests</h1>
      <p style={styles.description}>
        Tests for weight tensor transformations and padding operations.
      </p>
      <div style={styles.card}>
        <h3 style={styles.cardTitle}>Test Cases</h3>
        <ul style={styles.list}>
          <li>Channel padding for texture alignment</li>
          <li>Weight reshaping for WebGL textures</li>
          <li>Filter reordering</li>
        </ul>
      </div>
      <div style={styles.notice}>
        <p>Test harness integration pending. See packages/core/tests/components/Conv2DWeightTransformsTests.tsx</p>
      </div>
    </div>
  );
}
