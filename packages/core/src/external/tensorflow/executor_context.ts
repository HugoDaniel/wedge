...
Original:
https://github.com/tensorflow/tfjs/blob/master/tfjs-converter/src/executor/execution_context.ts

*/

import { TFTensor } from "./core/tensor";
import { NamedTensorsMap } from "./types";
...
export class ExecutionContext {
  ...
  getWeight(name: string): TFTensor[] {
    return this.weightMap[name];
  }

  // addTensorArray(tensorArray: TFTensorArray) {
  //   this.tensorArrayMap[tensorArray.id] = tensorArray;
  // }

  // getTensorArray(id: number): TFTensorArray {
  //   return this.tensorArrayMap[id];
  // }

  // addTensorList(tensorList: TFTensorList) {
  //   this.tensorListMap[tensorList.id] = tensorList;
  // }

  // getTensorList(id: number): TFTensorList {
