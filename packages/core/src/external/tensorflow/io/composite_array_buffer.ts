...
Original:
https://github.com/tensorflow/tfjs/blob/master/tfjs-core/src/io/composite_array_buffer.ts

*/

import { TypedArray } from "../../../types";
import { isTypedArrayBrowser } from "../../../util";
...
export class CompositeArrayBuffer {
  ...
  constructor(buffers?: ArrayBuffer | ArrayBuffer[] | TypedArray |
    ...
    buffers = buffers.map((bufferOrTypedArray) => {
      if (isTypedArrayBrowser(bufferOrTypedArray)) {
