...
/*
Original:
https://github.com/tensorflow/tfjs-converter/blob/master/tfjs-converter/src/data/compiled_api.ts
*/
...
/** Properties of a TFGraphDef. */
export declare interface ITFGraphDef {
  /** TFGraphDef node */
  node?: (INodeDef[] | null);
